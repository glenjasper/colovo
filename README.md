# COLOVO
Sistema Híbrido de Visão Computacional para Classificação de Gemas de Ovos. O COLOVO é uma plataforma automatizada voltada para a avicultura de precisão e controle de qualidade laboratorial. Seu objetivo principal é mensurar o nível de pigmentação da gema do ovo com base na escala comercial DSM (Digital Yolk Color Fan).
...
```
> *Nota*: Para fins acadêmicos, o projeto COLOVO encontra-se implantado na plataforma Streamlit Community Cloud: <a href="https://colovo.streamlit.app" target="_blank">colovo.streamlit.app</a>
